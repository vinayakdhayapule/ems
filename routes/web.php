...
Route::get('product-list',['as'=>'product.list',
	                        'uses'=>'ApiProductController@getProductList']);

Route::post('product-add',['as'=>'product.add',
	                       'uses'=>'ApiProductController@addProduct']);

Route::get('product-show/{id}',['as'=>'product.show',
	                            'uses'=>'ApiProductController@showProduct']);

Route::post('product-delete/{id}',['as'=>'product.delete',
	                                'uses'=>'ApiProductController@deleteProduct']);

Route::post('product-edit/{id}',['as'=>'product.edit',
	                                'uses'=>'ApiProductController@editProduct']);
});
